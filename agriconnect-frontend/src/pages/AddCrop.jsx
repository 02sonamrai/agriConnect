  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setApiError(
        ...
        'Failed to save listing. Please check inputs and try again.'
      );
    } finally {
  ...
  return (
    <div className="space-y-6 max-w-3xl mx-auto selection:bg-lime-500 selection:text-slate-900">
      ...
      <div className="flex items-center space-x-2">
        <Link to="/farmer/dashboard" className="text-slate-500 hover:text-slate-300 text-sm flex items-center space-x-1 transition">
      ...
      <div className="bg-slate-900 border border-slate-800 rounded-3xl p-6 md:p-8 shadow-2xl">
        <div className="flex items-center space-x-3 mb-6 border-b border-slate-800 pb-5">
          ...
          <div>
            <h1 className="text-2xl font-extrabold text-white tracking-tight">Add New Crop</h1>
            <p className="text-slate-500 text-xs mt-0.5">Publish a crop harvest to the marketplace.</p>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <textarea
              ...
              onChange={handleChange}
              placeholder="Provide crop specific details like organic harvesting methods, quality parameters, moisture level..."
              className={`block w-full px-4 py-3 bg-slate-950 border rounded-xl focus:outline-none focus:ring-2 focus:ring-lime-500/50 text-slate-100 placeholder-slate-600 transition text-sm ${
          ...
          <div className="flex justify-end space-x-3 border-t border-slate-800/80 pt-6">
            <Link
              to="/farmer/crops"
              className="bg-slate-950 hover:bg-slate-900 border border-slate-850 text-slate-400 font-semibold py-3 px-6 rounded-xl transition text-sm"
            >
              Cancel
            </Link>
            <button
