...
import { Leaf, LogOut, Menu, X, User, ShoppingBag } from 'lucide-react';
...
const BuyerLayout = () => {
  ...
  const isActive = (path) => location.pathname === path || (path === '/marketplace' && location.pathname.startsWith('/marketplace/crops'));
